...
export const newFlowLayout = (nodes: EipFlowNode[], edges: Edge[], layout: LayoutOrientation, constraint: GraphConstraint) => {
  ...
  graph.setGraph({ rankdir: direction , edgesep: seperation, ranksep: seperation})
